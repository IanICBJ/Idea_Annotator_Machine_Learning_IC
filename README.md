...
1) Look at Sprint 3 notebooks to understand the clean prototype setup using train.jsonl, val.jsonl, and test.jsonl.

2) Inspect how dataset.jsonl and dataset_full.jsonl relate to these splits.

3) Move to Sprint 4 Track 0 to see how dataset_full.jsonl is converted into the fixed split file.

4) Explore Track 1 and Track 2 to see how BERT and T5 behave on the real dataset and how their outputs are improved.
